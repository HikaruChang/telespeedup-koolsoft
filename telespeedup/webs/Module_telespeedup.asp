...
<div class="box boxr1" style="margin-top: 0px;">
	...
	<script type="text/javascript">
		...
		{ title: 'Check代码', name: 'telespeedup_check_Qos', type: 'text', maxlen: 100, size: 100, value: dbus.telespeedup_check_Qos ||"",suffix: ' 请填写Check代码，例如：curl -H \'SessionKey: .....' },
		{ title: 'Start代码', name: 'telespeedup_Start_Qos', type: 'text', maxlen: 100, size: 100, value: dbus.telespeedup_Start_Qos ||"",suffix: ' 请填写Start代码，例如：curl -H \'SessionKey: .....' },
		{ title: 'Heart代码', name: 'telespeedup_Heart_Qos', type: 'text', maxlen: 100, size: 100, value: dbus.telespeedup_Heart_Qos ||"",suffix: ' 选填代码，Start后没提速可尝试填入，例如：curl -H \'SessionKey: .....' },
		]);
